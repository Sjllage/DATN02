...
import DoctorHomeScreen from './src/chuc_nang/DoctorHomeScreen';
  ...
  return (
    <NavigationContainer>
      <Tab.Navigator screenOptions={{headerShown: false}}>
        ...
        <Tab.Screen
          ...
          options={{
            tabBarIcon: ({focused}) => (
              <TabIcon
                focused={focused}
                icon_ed={images.icon_options}
                icon={images.icon_options}
              />
            ),
          }}
        />
        ...
        <Tab.Screen
          name="ChangedProfileScreen"
          component={ChangedProfileScreen}
        ...
        <Tab.Screen
          ...
          options={{
            ...
            tabBarIcon: ({focused}) => (
              <TabIcon
                focused={focused}
                icon_ed={images.Forgot_Pass}
                icon={images.Forgot_Pass}
              />
            ),
          }}
        />
